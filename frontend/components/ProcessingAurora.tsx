...
export const STEP_DESCRIPTIONS: Record<string, { title: string; body: string; tip: string }> = {
  queued: {
...
export function ProcessingAurora({ jobId, status, progress, message, elapsed, copied, onCopyId, onBack }: ProcessingProps) {
